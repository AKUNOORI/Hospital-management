    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('availableTimeDate', models.DateTimeField()),
                ('endTimeDate', models.DateTimeField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('admin', 'Admin'), ('doctor', 'Doctor'), ('nurse', 'Nurse'), ('receptionist', 'Receptionist'), ('patient', 'Patient')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invoice', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hospital_App.invoice')),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
